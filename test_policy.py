...
exp_name = "ppo-tradingdataset=None-start_skipNone-durationNone-fs=1-ts=1-ss=1.5-ap=0.5dl=30clip=0-pilr=4e-05-vlr=0.0001"
# exp_name = "ppo-baseset-c12-ap0.5-fs=1-ss=1.0-ap=0.5"
fpath = "/home/shuai/trading-game/spinningup/data/" + exp_name + "/" + exp_name + "_s0"
fname = osp.join(fpath, 'tf1_save2.467200')
# 6000: 137
# 5000: 133
# 4000: 133
# 3000: 137
