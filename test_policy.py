...
exp_name = "ppo-m343-b36000-l3000-td_30-c12-set3-fs1"

fpath = "/home/shuai/trading-game/spinningup/data/" + exp_name + "/" + exp_name + "_s0"

fname = osp.join(fpath, 'tf1_save14000')
print('\n\nLoading from %s.\n\n ' % fname)
...
#     o, r, d, ep_ret, ep_len, n = env.reset(start_day=start, skip_step=0), 0, False, 0, 0, 0
...
#
#         if d:
#             print("TradingDay:", info['TradingDay'], "baseline profit:", env.rewards[3], "profit:", env.rewards[1],
#                   "score:", env.rewards[0], "target_bias:", ep_target_bias)
#             print("-----")
